...
static const uint8_t attcMinPduLen[] =
{
  ATT_ERR_RSP_LEN,              /* ATT_METHOD_ERR */
  ATT_MTU_RSP_LEN,              /* ATT_METHOD_MTU */
  ATT_FIND_INFO_RSP_LEN,        /* ATT_METHOD_FIND_INFO */
  ATT_FIND_TYPE_RSP_LEN,        /* ATT_METHOD_FIND_TYPE */
  ATT_READ_TYPE_RSP_LEN,        /* ATT_METHOD_READ_TYPE */
  ATT_READ_RSP_LEN,             /* ATT_METHOD_READ */
  ATT_READ_BLOB_RSP_LEN,        /* ATT_METHOD_READ_BLOB */
  ATT_READ_MULT_RSP_LEN,        /* ATT_METHOD_READ_MULTIPLE */
  ATT_READ_GROUP_TYPE_RSP_LEN,  /* ATT_METHOD_READ_GROUP_TYPE */
  ATT_WRITE_RSP_LEN,            /* ATT_METHOD_WRITE */
  ATT_WRITE_CMD_LEN,            /* ATT_METHOD_WRITE_CMD */
  ATT_PREP_WRITE_RSP_LEN,       /* ATT_METHOD_PREPARE_WRITE */
  ATT_EXEC_WRITE_RSP_LEN        /* ATT_METHOD_EXECUTE_WRITE */
};
